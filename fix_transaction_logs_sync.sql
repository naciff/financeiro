-- Fix "INSERT has more expressions than target columns" error
-- This error happens because 'transactions' table has new columns that are missing in 'transaction_logs'
-- We will rebuild the log table to match exactly correctly.
